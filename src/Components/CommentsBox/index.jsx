...
import S from './commentsBox.module.scss';
import { motion, AnimatePresence } from 'framer-motion';
import { useGetCommentsQuery } from '../../Redux/getDataSlice';
...
const CommentsBox = (params) => {
  ...
  const [loader, setLoader] = React.useState(false); //для задержки лоадера
